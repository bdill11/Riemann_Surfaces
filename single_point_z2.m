...
surf(x1,y1,zeros(size(x1)), 'FaceColor', [.5 .5 .5],'FaceAlpha', 0.5)
...
while(abs(mousex - xmax) >(dx/5) || abs(mousey- ymax) >(dy/5))
    ...
    title(strcat('Riemann Surface and Image of z = ', num2str(mousex), '+', num2str(mousey),' i'),'color','b')
